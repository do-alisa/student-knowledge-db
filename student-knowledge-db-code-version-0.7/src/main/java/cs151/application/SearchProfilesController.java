...
public class SearchProfilesController {
    ...
    private void initialize() {
        ...
        // Faculty evaluation column (reads "FACULTY_NOTE|..." from comments)
        facultyCol.setCellValueFactory(c -> new SimpleStringProperty(extractFacultyNote(c.getValue())));
    ...
    // Extract "FACULTY_NOTE|..." from comments
